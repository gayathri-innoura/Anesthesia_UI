                        ...
                        <div className="row">
                                    ...
                                    <div className="card-body">
                                        <div className="d-flex align-items-center justify-content-between">
                                            <div className={`icon-box icon-box-lg rounded-circle bg-success-light`} >
                                                <div className="dashboard-icon-bac">
                                                    <svg
                                            ...
                                            <div className="total-projects ms-3">
                                                <h3 className={`count text-success`}>55</h3>
                                                <span>NEW</span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="col-xl-3 col-sm-6" >
                                <div className="card dashboard-card">
                                    <div className="card-body">
                                        <div className="d-flex align-items-center justify-content-between">
                                            <div className={`icon-box icon-box-lg rounded-circle bg-danger`} >
                                                <div className="dashboard-icon-bac" style={{ backgroundColor: "#FF0000" }}>
                                                    <svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        width="30"
                                                        height="30"
                                            ...
                                            <div className="total-projects ms-3">
                                                <h3 className={`count text-danger`}>32</h3>
                            ...
                            <div className="col-xl-3 col-sm-6" >
                                <div className="card dashboard-card">
                                    <div className="card-body">
                                        <div className="d-flex align-items-center justify-content-between">
                                            <div className={`icon-box icon-box-lg rounded-circle bg-success-light`} >
                                                <div className="dashboard-icon-bac" style={{ backgroundColor: "#14E600" }}>
                                                    <svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        width="30"
                                                        height="30"
                                            ...
                                            <div className="total-projects ms-3">
                                                <h3 className={`count text-success`}>15</h3>
                            ...
                            <div className="col-xl-3 col-sm-6" >
                                <div className="card dashboard-card">
                                    <div className="card-body">
                                        <div className="d-flex align-items-center justify-content-between">
                                            <div className={`icon-box icon-box-lg rounded-circle bg-success-light`} >
                                                <div className="dashboard-icon-bac" style={{ backgroundColor: "#E1E12A" }}>
                                                    <svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        width="30"
                                                        height="30"
                                            ...
                                            <div className="total-projects ms-3">
                                                <h3 className={`count text-success`}>25</h3>
                                                <span>IN - AUDIT</span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="col-xl-3 col-sm-6" >
                                <div className="card dashboard-card">
                                    <div className="card-body">
                                        <div className="d-flex align-items-center justify-content-between">
                                            <div className={`icon-box icon-box-lg rounded-circle bg-success-light`} >
                                                <div className="dashboard-icon-bac" style={{ backgroundColor: "#EAE316" }}>
                                                    <svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        width="30"
                                                        height="30"
                                            ...
                                            <div className="total-projects ms-3">
                                                <h3 className={`count text-success`}>49</h3>
                                                <span>IN - RE AUDIT</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="col-xl-3 col-sm-6" >
                                <div className="card dashboard-card">
                                    <div className="card-body">
                                        <div className="d-flex align-items-center justify-content-between">
                                            <div className={`icon-box icon-box-lg rounded-circle bg-success-light`} >
                                                <div className="dashboard-icon-bac" style={{ backgroundColor: "#FFA500" }}>
                                                    <svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        width="30"
                                                        height="30"
                                            ...
                                            <div className="total-projects ms-3">
                                                <h3 className={`count text-success`}>22</h3>
                                                <span>QC</span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="col-xl-3 col-sm-6" >
                                <div className="card dashboard-card">
                                    <div className="card-body">
                                        <div className="d-flex align-items-center justify-content-between">
                                            <div className={`icon-box icon-box-lg rounded-circle bg-success-light`} >
                                                <div className="dashboard-icon-bac" style={{ backgroundColor: "#FFC04D" }}>
                                                    <svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        width="30"
                                                        height="30"
                                            ...
                                            <div className="total-projects ms-3">
                                                <h3 className={`count text-success`}>07</h3>
                                                <span>IN-QC</span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="col-xl-3 col-sm-6" >
                                <div className="card dashboard-card">
                                    <div className="card-body">
                                        <div className="d-flex align-items-center justify-content-between">
                                            <div className={`icon-box icon-box-lg rounded-circle bg-success-light`} >
                                                <div className="dashboard-icon-bac" style={{ backgroundColor: "#0000FF" }}>
                                                    <svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        width="30"
                                                        height="30"
                                            ...
                                            <div className="total-projects ms-3">
                                                <h3 className={`count text-success`}>78</h3>
                                                <span>COMPLETED</span>
                                            </div>
                                        </div>
                                    </div>
